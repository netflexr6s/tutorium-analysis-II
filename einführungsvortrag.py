...
class Vortrag(Scene):
    ...
    ## Titelseite
        ...
        rect.stretch_to_fit_width(self.camera.frame.get_width())
    ...
    ## Teil 1
        ...
        massenpunkt_axes.shift(
            pend1.get_fixed_point() - massenpunkt_axes.get_origin()
        ...
        self.interact()
        self.play(
            TransformMatchingTex(mgFma3, mgFma4)
        )
        self.interact()
        self.play(
            FadeOut(
